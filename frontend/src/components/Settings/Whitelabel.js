                ...
                <FormControl className={classes.selectContainer}>
                  <TextField
                    ...
                    onBlur={async (_) => {
                      ...
                      colorMode.setAppName(appName || "whiticket");
                    }}
                    InputProps={{
                      style: {
                        color: "#ffffff",
              ...
              <Grid xs={12} sm={6} md={4} item>
                <div className={classes.appLogoLightPreviewDiv}>
                  <img
                    ...
                    src={settingsLoaded.appLogoLight ? getBackendUrl() + "/public/" + settingsLoaded.appLogoLight : defaultLogoLight}
                    style={{ maxHeight: 72, width: "100%" }}
                  />
                </div>
              </Grid>
              <Grid xs={12} sm={6} md={4} item>
              ...
              <Grid xs={12} sm={6} md={4} item>
                <div className={classes.appLogoFaviconPreviewDiv}>
                  <img
                    ...
                    alt="favicon-preview"
                    src={settingsLoaded.appLogoFavicon ? getBackendUrl() + "/public/" + settingsLoaded.appLogoFavicon : defaultLogoFavicon}
                    style={{ maxHeight: 72, width: "100%" }}
                  />
                </div>
              </Grid>
